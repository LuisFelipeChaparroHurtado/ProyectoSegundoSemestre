 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR INFORMACION 
    DE LA AZAFATAS DE ATENCION AL CLIENTE
 */
package menu;
...
public class Mostrar_ListaAzAtenC extends javax.swing.JFrame implements ActionListener {
    ...
    public Mostrar_ListaAzAtenC(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA TRABAJADOR 'AZAFATA ATENCIÓN AL CLIENTE'");
        ...
        //TITULO
        titulo = new JLabel("LISTA AZAFATAS 'AZAFATA ATEN.CLIENTE'", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrar_LAzafataAten());
