...
public class Mostrar_ListaVC extends javax.swing.JFrame implements ActionListener {
    ...
    public Mostrar_ListaVC(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA VUELO DE CARGA");
        ...
        //TITULO
        titulo = new JLabel("LISTA VUELO DE CARGA", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrarCar());
