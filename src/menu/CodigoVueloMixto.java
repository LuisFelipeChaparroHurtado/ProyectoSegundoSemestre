 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE EL VUELO MIXTO
 */
package menu;
...
public class CodigoVueloMixto extends javax.swing.JFrame{
    ...
    public CodigoVueloMixto(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoVueloMixto());
