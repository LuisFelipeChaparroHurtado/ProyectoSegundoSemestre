...
public class Mostrar_ListaAzC extends javax.swing.JFrame implements ActionListener{
    ...
    public Mostrar_ListaAzC(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA TRABAJADOR 'AZAFATA COMIDA'");
        ...
        //TITULO
        titulo = new JLabel("LISTA AZAFATAS 'COMIDA'", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrar_LAzafataC());
