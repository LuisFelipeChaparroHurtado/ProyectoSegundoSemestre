...
public class Mostrar_ListaVP extends javax.swing.JFrame implements ActionListener{
    ...
    public Mostrar_ListaVP(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA VUELO DE PASAJEROS");
        ...
        //TITULO
        titulo = new JLabel("LISTA VUELO DE PASAJEROS", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrarPasa());
