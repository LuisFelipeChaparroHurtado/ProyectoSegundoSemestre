 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE EL VUELO DE CARGA
 */
package menu;
...
public class CodigoVueloCarga extends javax.swing.JFrame{
    ...
    public CodigoVueloCarga(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoVueloCarga());
