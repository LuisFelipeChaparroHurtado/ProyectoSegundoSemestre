...
public class Mostrar_ListaVM extends javax.swing.JFrame implements ActionListener {
    ...
    public Mostrar_ListaVM(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA VUELO MIXTO");
        ...
        //TITULO
        titulo = new JLabel("LISTA VUELO MIXTO", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrarMix());
