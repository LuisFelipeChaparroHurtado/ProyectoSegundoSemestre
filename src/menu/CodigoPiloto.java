 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE PILOTO
 */
package menu;
...
public class CodigoPiloto extends javax.swing.JFrame{
    ...
    public CodigoPiloto(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoPiloto());
