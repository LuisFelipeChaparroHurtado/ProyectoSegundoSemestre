 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE LA AZAFATA DE SEGURIDAD
 */
package menu;
...
public class CodigosAzafataS extends javax.swing.JFrame{
    ...
    public CodigosAzafataS(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoAzafataS());
