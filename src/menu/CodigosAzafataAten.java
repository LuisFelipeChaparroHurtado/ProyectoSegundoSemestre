 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE LA AZAFATA DE ATENCION AL CLIENTE
 */
package menu;
...
public class CodigosAzafataAten extends javax.swing.JFrame{
    ...
    public CodigosAzafataAten(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoAzafataAt());
