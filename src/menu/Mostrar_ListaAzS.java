...
public class Mostrar_ListaAzS extends javax.swing.JFrame implements ActionListener {
    ...
    public Mostrar_ListaAzS(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA TRABAJADOR 'AZAFATA SEGURIDAD'");
        ...
        //TITULO
        titulo = new JLabel("LISTA AZAFATAS 'SEGURIDAD'", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrar_LAzafataS());
