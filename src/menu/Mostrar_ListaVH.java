...
public class Mostrar_ListaVH extends javax.swing.JFrame implements ActionListener {
    ...
    public Mostrar_ListaVH(Aerolinea aerolinea) {
        ...
        this.setTitle("LISTA VUELO HUMANITARIO");
        ...
        //TITULO
        titulo = new JLabel("LISTA VUELO HUMANITARIO", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrarHum());
