 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE EL VUELO HUMANITARIO
 */
package menu;
...
public class CodigoVueloHuma extends javax.swing.JFrame{
    ...
    public CodigoVueloHuma(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodigoVueloHuman());
