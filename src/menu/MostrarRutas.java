 ...
 * FECHA: 03/06/2020
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR INFORMACION DE LA RUTAS
 */
package menu;
...
public class MostrarRutas extends javax.swing.JFrame implements ActionListener {
    ...
    public MostrarRutas(Aerolinea aerolinea) {
        ...
        //TITULO
        titulo = new JLabel("RUTAS DE AEROLINEA", SwingConstants.CENTER);
        ...
        areaTexto.setText(aerolinea.mostrarRutas());
    ...
    public void actionPerformed(ActionEvent e) {
        //SE DA LA OPCIÓN PARA QUE AL DAR CLICK SOBRE EL BOTON DESAPAREZCA
