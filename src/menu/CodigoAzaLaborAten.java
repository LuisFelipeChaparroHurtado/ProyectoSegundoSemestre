 ...
 * DESCRIPCIÓN: SE CREA LA CLASE JFRAME COMO INTERFACE PARA MOSTRAR EN UN JSCROLL 
    LOS CODIGOS ESPECIFICOS DE LA AZAFATA DE COMIDA
 */
package menu;
...
public class CodigoAzaLaborAten extends javax.swing.JFrame{
    ...
    public CodigoAzaLaborAten(Aerolinea aerolinea) {
        ...
        areaTexto.setText(aerolinea.mostrar_CodAten());
